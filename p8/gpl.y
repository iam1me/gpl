...
initialization_block:
	...
	{
		GPL_BEGIN_BLOCK("initialization_block")

		std::shared_ptr<statement_block> pHandler($2);
		Window::Keystroke key = Window::INITIALIZE;
		Event_manager::instance()->add_handler(key, pHandler);
